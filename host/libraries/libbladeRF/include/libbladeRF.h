...
#define BLADERF_BTLE_CONTROL_RF_ID_MASK (0x03 << 0)
...
#define BLADERF_BTLE_WINDOW_SHIFT   (7)
#define BLADERF_BTLE_WINDOW_MASK    (0x3 << BLADERF_BTLE_WINDOW_SHIFT)

#define BLADERF_BTLE_WINDOW_HANNING (0x0 << BLADERF_BTLE_WINDOW_SHIFT)
#define BLADERF_BTLE_WINDOW_HAMMING (0x1 << BLADERF_BTLE_WINDOW_SHIFT)
#define BLADERF_BTLE_WINDOW_NONE    (0x2 << BLADERF_BTLE_WINDOW_SHIFT)
