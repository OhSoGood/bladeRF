...
module fft_ii_0_example_design (
		...
		input  wire [37:0] core_sink_data,            //            .data
	...
	fft_ii_0_example_design_core core (
		...
		.sink_real    ({core_sink_data[37:22]}),   //       .data
		.sink_imag    ({core_sink_data[21:6]}),    //       .data
		.fftpts_in    ({core_sink_data[5:1]}),     //       .data
		...
		.fftpts_out   (core_fftpts_out)            //       .data
	);

	assign core_source_data = { core_source_real[15:0], core_source_imag[15:0], core_fftpts_out[4:0] };
