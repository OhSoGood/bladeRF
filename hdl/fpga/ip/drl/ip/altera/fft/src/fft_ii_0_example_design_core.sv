...
module  fft_ii_0_example_design_core
	...
	reg	n1OO1i;
	reg	n011Ol_clk_prev;
	wire	wire_n011Ol_CLRN;
	wire	wire_n011Ol_PRN;
	reg	n11l1i;
	reg	n11l1l;
	reg	n1i0lO;
	reg	nll00Oi;
	...
	defparam
		...
		nl110i.init_file = "fft_ii_0_example_design_core_opt_twr1.hex",
	...
	.clock0(clk),
	.clocken0((niO100i | wire_nlOOiO_dataout)),
	...
	always @ ( posedge clk)
		  nilOl0i75 <= nilOl0i76;
	event nilOl0i75_event;
	initial
		#1 ->nilOl0i75_event;
	always @(nilOl0i75_event)
		nilOl0i75 <= {1{1'b1}};
	initial
		nilOl0i76 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOl0l73 <= nilOl0l74;
	event nilOl0l73_event;
	initial
		#1 ->nilOl0l73_event;
	always @(nilOl0l73_event)
		nilOl0l73 <= {1{1'b1}};
	initial
		nilOl0l74 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOl1i79 <= nilOl1i80;
	event nilOl1i79_event;
	initial
		#1 ->nilOl1i79_event;
	always @(nilOl1i79_event)
		nilOl1i79 <= {1{1'b1}};
	initial
		nilOl1i80 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOl1l77 <= nilOl1l78;
	event nilOl1l77_event;
	initial
		#1 ->nilOl1l77_event;
	always @(nilOl1l77_event)
		nilOl1l77 <= {1{1'b1}};
	initial
		nilOl1l78 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOliO71 <= nilOliO72;
	event nilOliO71_event;
	initial
		#1 ->nilOliO71_event;
	always @(nilOliO71_event)
		nilOliO71 <= {1{1'b1}};
	initial
		nilOliO72 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOlli69 <= nilOlli70;
	event nilOlli69_event;
	initial
		#1 ->nilOlli69_event;
	always @(nilOlli69_event)
		nilOlli69 <= {1{1'b1}};
	initial
		nilOlli70 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOlOl67 <= nilOlOl68;
	event nilOlOl67_event;
	initial
		#1 ->nilOlOl67_event;
	always @(nilOlOl67_event)
		nilOlOl67 <= {1{1'b1}};
	initial
		nilOlOl68 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOlOO65 <= nilOlOO66;
	event nilOlOO65_event;
	initial
		#1 ->nilOlOO65_event;
	always @(nilOlOO65_event)
		nilOlOO65 <= {1{1'b1}};
	initial
		nilOlOO66 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOOOi63 <= nilOOOi64;
	event nilOOOi63_event;
	initial
		#1 ->nilOOOi63_event;
	always @(nilOOOi63_event)
		nilOOOi63 <= {1{1'b1}};
	initial
		nilOOOi64 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  nilOOOl61 <= nilOOOl62;
	event nilOOOl61_event;
	initial
		#1 ->nilOOOl61_event;
	always @(nilOOOl61_event)
		nilOOOl61 <= {1{1'b1}};
	initial
		nilOOOl62 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO101i53 <= niO101i54;
	event niO101i53_event;
	initial
		#1 ->niO101i53_event;
	always @(niO101i53_event)
		niO101i53 <= {1{1'b1}};
	initial
		niO101i54 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO10ii49 <= niO10ii50;
	event niO10ii49_event;
	initial
		#1 ->niO10ii49_event;
	always @(niO10ii49_event)
		niO10ii49 <= {1{1'b1}};
	initial
		niO10ii50 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO10iO47 <= niO10iO48;
	event niO10iO47_event;
	initial
		#1 ->niO10iO47_event;
	always @(niO10iO47_event)
		niO10iO47 <= {1{1'b1}};
	initial
		niO10iO48 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO10ll45 <= niO10ll46;
	event niO10ll45_event;
	initial
		#1 ->niO10ll45_event;
	always @(niO10ll45_event)
		niO10ll45 <= {1{1'b1}};
	initial
		niO10ll46 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO10Oi43 <= niO10Oi44;
	event niO10Oi43_event;
	initial
		#1 ->niO10Oi43_event;
	always @(niO10Oi43_event)
		niO10Oi43 <= {1{1'b1}};
	initial
		niO10Oi44 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO11il59 <= niO11il60;
	event niO11il59_event;
	initial
		#1 ->niO11il59_event;
	always @(niO11il59_event)
		niO11il59 <= {1{1'b1}};
	initial
		niO11il60 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO11iO57 <= niO11iO58;
	event niO11iO57_event;
	initial
		#1 ->niO11iO57_event;
	always @(niO11iO57_event)
		niO11iO57 <= {1{1'b1}};
	initial
		niO11iO58 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO11OO55 <= niO11OO56;
	event niO11OO55_event;
	initial
		#1 ->niO11OO55_event;
	always @(niO11OO55_event)
		niO11OO55 <= {1{1'b1}};
	initial
		niO11OO56 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1i0i39 <= niO1i0i40;
	event niO1i0i39_event;
	initial
		#1 ->niO1i0i39_event;
	always @(niO1i0i39_event)
		niO1i0i39 <= {1{1'b1}};
	initial
		niO1i0i40 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1i0O37 <= niO1i0O38;
	event niO1i0O37_event;
	initial
		#1 ->niO1i0O37_event;
	always @(niO1i0O37_event)
		niO1i0O37 <= {1{1'b1}};
	initial
		niO1i0O38 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1i1i41 <= niO1i1i42;
	event niO1i1i41_event;
	initial
		#1 ->niO1i1i41_event;
	always @(niO1i1i41_event)
		niO1i1i41 <= {1{1'b1}};
	initial
		niO1i1i42 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1iiO35 <= niO1iiO36;
	event niO1iiO35_event;
	initial
		#1 ->niO1iiO35_event;
	always @(niO1iiO35_event)
		niO1iiO35 <= {1{1'b1}};
	initial
		niO1iiO36 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1iOO29 <= niO1iOO30;
	event niO1iOO29_event;
	initial
		#1 ->niO1iOO29_event;
	always @(niO1iOO29_event)
		niO1iOO29 <= {1{1'b1}};
	initial
		niO1iOO30 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1l0i21 <= niO1l0i22;
	event niO1l0i21_event;
	initial
		#1 ->niO1l0i21_event;
	always @(niO1l0i21_event)
		niO1l0i21 <= {1{1'b1}};
	initial
		niO1l0i22 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1l0O19 <= niO1l0O20;
	event niO1l0O19_event;
	initial
		#1 ->niO1l0O19_event;
	always @(niO1l0O19_event)
		niO1l0O19 <= {1{1'b1}};
	initial
		niO1l0O20 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1l1i27 <= niO1l1i28;
	event niO1l1i27_event;
	initial
		#1 ->niO1l1i27_event;
	always @(niO1l1i27_event)
		niO1l1i27 <= {1{1'b1}};
	initial
		niO1l1i28 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1l1l25 <= niO1l1l26;
	event niO1l1l25_event;
	initial
		#1 ->niO1l1l25_event;
	always @(niO1l1l25_event)
		niO1l1l25 <= {1{1'b1}};
	initial
		niO1l1l26 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1lii17 <= niO1lii18;
	event niO1lii17_event;
	initial
		#1 ->niO1lii17_event;
	always @(niO1lii17_event)
		niO1lii17 <= {1{1'b1}};
	initial
		niO1lii18 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1lil15 <= niO1lil16;
	event niO1lil15_event;
	initial
		#1 ->niO1lil15_event;
	always @(niO1lil15_event)
		niO1lil15 <= {1{1'b1}};
	initial
		niO1lil16 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1liO13 <= niO1liO14;
	event niO1liO13_event;
	initial
		#1 ->niO1liO13_event;
	always @(niO1liO13_event)
		niO1liO13 <= {1{1'b1}};
	initial
		niO1liO14 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1lll11 <= niO1lll12;
	event niO1lll11_event;
	initial
		#1 ->niO1lll11_event;
	always @(niO1lll11_event)
		niO1lll11 <= {1{1'b1}};
	initial
		niO1lll12 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1lOl9 <= niO1lOl10;
	event niO1lOl9_event;
	initial
		#1 ->niO1lOl9_event;
	always @(niO1lOl9_event)
		niO1lOl9 <= {1{1'b1}};
	initial
		niO1O0i5 = 0;
	always @ ( posedge clk)
	...
	always @ ( posedge clk)
		  niO1O1i7 <= niO1O1i8;
	event niO1O1i7_event;
	initial
		#1 ->niO1O1i7_event;
	always @(niO1O1i7_event)
		niO1O1i7 <= {1{1'b1}};
	initial
		niO1O1i8 = 0;
	always @ ( posedge clk)
	...
	always @ (clk or wire_n011Ol_PRN or wire_n011Ol_CLRN)
	begin
		if (wire_n011Ol_PRN == 1'b0) 
		begin
			n011ll <= 1;
			n011lO <= 1;
			n011Oi <= 1;
		...
		else if  (nilOllO == 1'b1) 
		if (clk != n011Ol_clk_prev && clk == 1'b1) 
		begin
	...
	assign
		wire_n011Ol_CLRN = ((nilOlli70 ^ nilOlli69) & reset_n),
		wire_n011Ol_PRN = (nilOliO72 ^ nilOliO71);
	initial
	begin
		n11l1i = 0;
		n11l1l = 0;
	...
	assign
		wire_n1i0ll_CLRN = (nilOl1l78 ^ nilOl1l77),
		wire_n1i0ll_PRN = (nilOl1i80 ^ nilOl1i79);
	initial
	begin
		n1O01i = 0;
		n1O01l = 0;
	...
	assign
		wire_n1Oi0O_CLRN = ((nilOl0l74 ^ nilOl0l73) & reset_n),
		wire_n1Oi0O_PRN = (nilOl0i76 ^ nilOl0i75);
	initial
	begin
		ni010i = 0;
		ni011i = 0;
	...
	always @ (clk or wire_ni10lO_PRN or wire_ni10lO_CLRN)
	begin
		if (wire_ni10lO_PRN == 1'b0) 
		begin
			ni10Oi <= 1;
			ni11ii <= 1;
			ni11il <= 1;
		...
		else if  (nilOlOi == 1'b1) 
		if (clk != ni10lO_clk_prev && clk == 1'b1) 
		begin
	...
	assign
		wire_ni10lO_CLRN = ((nilOlOO66 ^ nilOlOO65) & reset_n),
		wire_ni10lO_PRN = (nilOlOl68 ^ nilOlOl67);
	initial
	begin
		ni00i = 0;
		ni00l = 0;
	...
	always @ (clk or wire_nii0i_PRN or reset_n)
	begin
	...
	assign
		wire_nii0i_PRN = (niO10ll46 ^ niO10ll45);
	initial
	begin
		niO0iOl = 0;
		niO0llO = 0;
	...
	assign
		wire_nl0liO_CLRN = ((nilOOOi64 ^ nilOOOi63) & reset_n);
	initial
	begin
		nl0llO = 0;
	end
	always @ (clk or reset_n or wire_nl0lll_CLRN)
	begin
		if (reset_n == 1'b0) 
		begin
			nl0llO <= 1;
	...
	assign
		wire_nl0lll_ENA = (wire_niOO0OO_dataout & niO111l),
		wire_nl0lll_CLRN = (nilOOOl62 ^ nilOOOl61);
	event nl0llO_event;
	initial
		#1 ->nl0llO_event;
	always @(nl0llO_event)
	...
	always @ ( posedge clk or  negedge wire_nliiO_CLRN)
	begin
		if (wire_nliiO_CLRN == 1'b0) 
		begin
			n110l <= 0;
			n110O <= 0;
			n11ii <= 0;
	...
	assign
		wire_nliiO_CLRN = ((niO1l0O20 ^ niO1l0O19) & reset_n);
	initial
	begin
		nliOO = 0;
	end
	...
	assign
		wire_nliOl_CLRN = (niO1lil16 ^ niO1lil15),
		wire_nliOl_PRN = ((niO1lii18 ^ niO1lii17) & reset_n);
	event nliOO_event;
	initial
		#1 ->nliOO_event;
	always @(nliOO_event)
	...
	always @ ( posedge clk or  negedge wire_nllii_CLRN)
	begin
		if (wire_nllii_CLRN == 1'b0) 
		begin
			n0l0i <= 0;
			n0l0l <= 0;
			n0l0O <= 0;
		...
		begin
			...
			niOi1ii <= ((sink_valid & sink_eop) & (~ nilO01l));
			niOi1Ol <= ((sink_valid & (~ sink_eop)) & nilO01l);
			...
			nlilO <= wire_nli0O_o;
			nliOi <= wire_nliii_o;
			nll0O <= (((((nliOlil | niOiiO) | (~ (niO1O1i8 ^ niO1O1i7))) | (nlOO1i | nlOiOO)) | nllil) | (~ (niO1lOl10 ^ niO1lOl9)));
			nll1i <= (((((~ source_ready) & niO1OiO) & (niO1lll12 ^ niO1lll11)) | (niO1lOi & nii0O)) | (~ (niO1liO14 ^ niO1liO13)));
	...
	assign
		wire_nllOii_CLRN = ((niO11iO58 ^ niO11iO57) & reset_n),
		wire_nllOii_PRN = (niO11il60 ^ niO11il59);
	initial
	begin
		nll0l0O = 0;
		nll0lii = 0;
	...
	always @ (clk or wire_nlOllO_PRN or wire_nlOllO_CLRN)
	begin
	...
	assign
		wire_nlOllO_CLRN = ((niO101i54 ^ niO101i53) & reset_n),
		wire_nlOllO_PRN = (niO11OO56 ^ niO11OO55);
	initial
	begin
		nlO00i = 0;
		nlO00l = 0;
	...
	always @ (clk or wire_nlOlOO_PRN or reset_n)
	begin
	...
	assign
		wire_nlOlOO_PRN = (niO101l52 ^ niO101l51);
	lpm_add_sub   n1O1lO
	( 
	.aclr((~ reset_n)),
	.add_sub(1'b1),
	...
	assign		wire_n000i_dataout = (niO100l === 1'b1) ? n0lll : n10Ol;
	...
	assign		wire_n000l_dataout = (niO100l === 1'b1) ? n0llO : n10OO;
	...
	assign		wire_n000O_dataout = (niO100l === 1'b1) ? n0lOi : n1i1i;
	...
	assign		wire_n001i_dataout = (niO100l === 1'b1) ? n0lil : n10ll;
	assign		wire_n001l_dataout = (niO100l === 1'b1) ? n0liO : n10lO;
	assign		wire_n001O_dataout = (niO100l === 1'b1) ? n0lli : n10Oi;
	...
	assign		wire_n00ii_dataout = (niO100l === 1'b1) ? n0lOl : n1i1l;
	...
	assign		wire_n00il_dataout = (niO100l === 1'b1) ? n0lOO : n1i1O;
	...
	assign		wire_n00iO_dataout = (niO100l === 1'b1) ? n0O1i : n1i0i;
	...
	assign		wire_n00li_dataout = (niO100l === 1'b1) ? n0O1l : n1i0l;
	...
	assign		wire_n00ll_dataout = (niO100l === 1'b1) ? n0O1O : n1i0O;
	...
	assign		wire_n00lO_dataout = (niO100l === 1'b1) ? n0O0i : n1iii;
	...
	assign		wire_n00Oi_dataout = (niO100l === 1'b1) ? n0O0l : n1iil;
	...
	assign		wire_n00Ol_dataout = (niO100l === 1'b1) ? n0O0O : n1iiO;
	...
	assign		wire_n00OO_dataout = (niO100l === 1'b1) ? n0Oii : n1ili;
	...
	assign		wire_n010i_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[11] : wire_n0i0O_dataout;
	and(wire_n010ii_dataout, wire_n010lO_o[0], ~(nilOlll));
	and(wire_n010il_dataout, wire_n010lO_o[1], ~(nilOlll));
	and(wire_n010iO_dataout, wire_n010lO_o[2], ~(nilOlll));
	assign		wire_n010l_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[12] : wire_n0iii_dataout;
	and(wire_n010li_dataout, wire_n010lO_o[3], ~(nilOlll));
	and(wire_n010ll_dataout, wire_n010lO_o[4], ~(nilOlll));
	assign		wire_n010O_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[13] : wire_n0iil_dataout;
	...
	assign		wire_n011i_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[8] : wire_n0i1O_dataout;
	assign		wire_n011l_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[9] : wire_n0i0i_dataout;
	assign		wire_n011O_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[10] : wire_n0i0l_dataout;
	assign		wire_n01ii_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[14] : wire_n0iiO_dataout;
	assign		wire_n01iiO_dataout = (niO000i === 1'b1) ? nlOl1ll : wire_n01iOi_o[0];
	assign		wire_n01il_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[15] : wire_n0ili_dataout;
	...
	assign		wire_n01iO_dataout = (niO100l === 1'b1) ? n1l0O : n11iO;
	assign		wire_n01li_dataout = (niO100l === 1'b1) ? n0l1l : n100l;
	assign		wire_n01ll_dataout = (niO100l === 1'b1) ? n0l1O : n100O;
	assign		wire_n01lO_dataout = (niO100l === 1'b1) ? n0l0i : n10ii;
	assign		wire_n01Oi_dataout = (niO100l === 1'b1) ? n0l0l : n10il;
	assign		wire_n01Ol_dataout = (niO100l === 1'b1) ? n0l0O : n10iO;
	assign		wire_n01OO_dataout = (niO100l === 1'b1) ? n0lii : n10li;
	assign		wire_n0i0i_dataout = (niO100l === 1'b1) ? n0Oll : n1iOl;
	assign		wire_n0i0l_dataout = (niO100l === 1'b1) ? n0OlO : n1iOO;
	assign		wire_n0i0O_dataout = (niO100l === 1'b1) ? n0OOi : n1l1i;
	...
	assign		wire_n0i1i_dataout = (niO100l === 1'b1) ? n0Oil : n1ill;
	...
	assign		wire_n0i1l_dataout = (niO100l === 1'b1) ? n0OiO : n1ilO;
	...
	assign		wire_n0i1O_dataout = (niO100l === 1'b1) ? n0Oli : n1iOi;
	assign		wire_n0iii_dataout = (niO100l === 1'b1) ? n0OOl : n1l1l;
	assign		wire_n0iil_dataout = (niO100l === 1'b1) ? n0OOO : n1l1O;
	assign		wire_n0iiO_dataout = (niO100l === 1'b1) ? ni11i : n1l0i;
	assign		wire_n0ili_dataout = (niO100l === 1'b1) ? ni11l : n1l0l;
	...
	assign		wire_n1lii_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[16] : wire_n01iO_dataout;
	...
	assign		wire_n1lil_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[17] : wire_n01li_dataout;
	...
	assign		wire_n1liO_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[18] : wire_n01ll_dataout;
	...
	assign		wire_n1lli_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[19] : wire_n01lO_dataout;
	...
	assign		wire_n1lll_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[20] : wire_n01Oi_dataout;
	...
	assign		wire_n1llO_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[21] : wire_n01Ol_dataout;
	...
	assign		wire_n1lOi_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[22] : wire_n01OO_dataout;
	...
	assign		wire_n1lOl_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[23] : wire_n001i_dataout;
	...
	assign		wire_n1lOO_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[24] : wire_n001l_dataout;
	...
	assign		wire_n1O0i_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[28] : wire_n000O_dataout;
	...
	assign		wire_n1O0l_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[29] : wire_n00ii_dataout;
	...
	assign		wire_n1O0O_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[30] : wire_n00il_dataout;
	...
	assign		wire_n1O1i_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[25] : wire_n001O_dataout;
	...
	assign		wire_n1O1l_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[26] : wire_n000i_dataout;
	assign		wire_n1O1O_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[27] : wire_n000l_dataout;
	...
	assign		wire_n1Oii_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[31] : wire_n00iO_dataout;
	assign		wire_n1Oil_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[0] : wire_n00li_dataout;
	assign		wire_n1OiO_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[1] : wire_n00ll_dataout;
	assign		wire_n1Oli_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[2] : wire_n00lO_dataout;
	assign		wire_n1Oll_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[3] : wire_n00Oi_dataout;
	assign		wire_n1OlO_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[4] : wire_n00Ol_dataout;
	or(wire_n1OO0i_dataout, wire_n1OO0l_dataout, nilOlii);
	and(wire_n1OO0l_dataout, n1Olil, ~(nilOl0O));
	assign		wire_n1OO0O_dataout = (nilOlii === 1'b1) ? wire_n0110O_o[0] : wire_n1OOll_dataout;
	and(wire_n1OO1l_dataout, nilOl0O, ~(nilOlii));
	assign		wire_n1OO1O_dataout = (nilOlii === 1'b1) ? nlOllOl : n011il;
	assign		wire_n1OOi_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[5] : wire_n00OO_dataout;
	assign		wire_n1OOii_dataout = (nilOlii === 1'b1) ? wire_n0110O_o[1] : wire_n1OOlO_dataout;
	assign		wire_n1OOil_dataout = (nilOlii === 1'b1) ? wire_n0110O_o[2] : wire_n1OOOi_dataout;
	assign		wire_n1OOiO_dataout = (nilOlii === 1'b1) ? wire_n0110O_o[3] : wire_n1OOOl_dataout;
	assign		wire_n1OOl_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[6] : wire_n0i1i_dataout;
	assign		wire_n1OOli_dataout = (nilOlii === 1'b1) ? wire_n0110O_o[4] : wire_n1OOOO_dataout;
	and(wire_n1OOll_dataout, wire_n0111i_dataout, ~(nilOl0O));
	and(wire_n1OOlO_dataout, wire_n0111l_dataout, ~(nilOl0O));
	assign		wire_n1OOO_dataout = (niO100O === 1'b1) ? wire_nlOi1O_q_b[7] : wire_n0i1l_dataout;
	and(wire_n1OOOi_dataout, wire_n0111O_dataout, ~(nilOl0O));
	and(wire_n1OOOl_dataout, wire_n0110i_dataout, ~(nilOl0O));
	and(wire_n1OOOO_dataout, wire_n0110l_dataout, ~(nilOl0O));
	...
	and(wire_ni01ll_dataout, wire_ni001i_o[0], ~(nilOO0i));
	and(wire_ni01lO_dataout, wire_ni001i_o[1], ~(nilOO0i));
	and(wire_ni01Oi_dataout, wire_ni001i_o[2], ~(nilOO0i));
	and(wire_ni01Ol_dataout, wire_ni001i_o[3], ~(nilOO0i));
	and(wire_ni01OO_dataout, wire_ni001i_o[4], ~(nilOO0i));
	...
	and(wire_ni1l0O_dataout, nilOO1i, ~(nilOO1l));
	assign		wire_ni1lii_dataout = (nilOO1l === 1'b1) ? n01l1l : ni1OlO;
	or(wire_ni1lil_dataout, wire_ni1liO_dataout, nilOO1l);
	and(wire_ni1liO_dataout, ni1iOi, ~(nilOO1i));
	assign		wire_ni1lli_dataout = (nilOO1l === 1'b1) ? wire_ni1Oli_o[0] : wire_ni1lOO_dataout;
	assign		wire_ni1lll_dataout = (nilOO1l === 1'b1) ? wire_ni1Oli_o[1] : wire_ni1O1i_dataout;
	assign		wire_ni1llO_dataout = (nilOO1l === 1'b1) ? wire_ni1Oli_o[2] : wire_ni1O1l_dataout;
	assign		wire_ni1lOi_dataout = (nilOO1l === 1'b1) ? wire_ni1Oli_o[3] : wire_ni1O1O_dataout;
	assign		wire_ni1lOl_dataout = (nilOO1l === 1'b1) ? wire_ni1Oli_o[4] : wire_ni1O0i_dataout;
	and(wire_ni1lOO_dataout, wire_ni1O0l_dataout, ~(nilOO1i));
	and(wire_ni1O0i_dataout, wire_ni1OiO_dataout, ~(nilOO1i));
	...
	and(wire_ni1O1i_dataout, wire_ni1O0O_dataout, ~(nilOO1i));
	and(wire_ni1O1l_dataout, wire_ni1Oii_dataout, ~(nilOO1i));
	and(wire_ni1O1O_dataout, wire_ni1Oil_dataout, ~(nilOO1i));
	...
	assign		wire_niiiO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[16] : wire_niOll_dataout;
	assign		wire_niili_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[17] : wire_niOlO_dataout;
	assign		wire_niill_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[18] : wire_niOOi_dataout;
	assign		wire_niilO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[19] : wire_niOOl_dataout;
	assign		wire_niiOi_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[20] : wire_niOOO_dataout;
	assign		wire_niiOl_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[21] : wire_nl11i_dataout;
	assign		wire_niiOO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[22] : wire_nl11l_dataout;
	assign		wire_nil0i_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[26] : wire_nl10O_dataout;
	assign		wire_nil0l_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[27] : wire_nl1ii_dataout;
	assign		wire_nil0O_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[28] : wire_nl1il_dataout;
	assign		wire_nil1i_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[23] : wire_nl11O_dataout;
	assign		wire_nil1l_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[24] : wire_nl10i_dataout;
	assign		wire_nil1O_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[25] : wire_nl10l_dataout;
	assign		wire_nilii_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[29] : wire_nl1iO_dataout;
	assign		wire_nilil_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[30] : wire_nl1li_dataout;
	assign		wire_niliO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[31] : wire_nl1ll_dataout;
	assign		wire_nilli_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[0] : wire_nl1lO_dataout;
	assign		wire_nilll_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[1] : wire_nl1Oi_dataout;
	assign		wire_nillli_dataout = ((~ nilOO0O) === 1'b1) ? n01liO : n01OlO;
	assign		wire_nillll_dataout = ((~ nilOO0O) === 1'b1) ? n01lli : n01OOi;
	assign		wire_nilllO_dataout = ((~ nilOO0O) === 1'b1) ? n01lll : n01OOl;
	assign		wire_nillO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[2] : wire_nl1Ol_dataout;
	assign		wire_nillOi_dataout = ((~ nilOO0O) === 1'b1) ? n01llO : n01OOO;
	assign		wire_nillOl_dataout = ((~ nilOO0O) === 1'b1) ? n01lOi : n0011i;
	assign		wire_nillOO_dataout = ((~ nilOO0O) === 1'b1) ? n01lOl : n0011l;
	assign		wire_nilO0i_dataout = ((~ nilOO0O) === 1'b1) ? n01O1O : n0010O;
	assign		wire_nilO0l_dataout = ((~ nilOO0O) === 1'b1) ? n01O0i : n001ii;
	assign		wire_nilO0O_dataout = ((~ nilOO0O) === 1'b1) ? n01O0l : n001il;
	assign		wire_nilO1i_dataout = ((~ nilOO0O) === 1'b1) ? n01lOO : n0011O;
	assign		wire_nilO1l_dataout = ((~ nilOO0O) === 1'b1) ? n01O1i : n0010i;
	assign		wire_nilO1O_dataout = ((~ nilOO0O) === 1'b1) ? n01O1l : n0010l;
	assign		wire_nilOi_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[3] : wire_nl1OO_dataout;
	assign		wire_nilOii_dataout = ((~ nilOO0O) === 1'b1) ? n01O0O : n001iO;
	assign		wire_nilOil_dataout = ((~ nilOO0O) === 1'b1) ? n01Oii : n001li;
	assign		wire_nilOiO_dataout = ((~ nilOO0O) === 1'b1) ? n01Oil : n001ll;
	assign		wire_nilOl_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[4] : wire_nl01i_dataout;
	assign		wire_nilOli_dataout = ((~ nilOO0O) === 1'b1) ? n01OiO : n001lO;
	assign		wire_nilOll_dataout = ((~ nilOO0O) === 1'b1) ? n01Oli : n001Oi;
	assign		wire_nilOlO_dataout = ((~ nilOO0O) === 1'b1) ? n01Oll : n001Ol;
	assign		wire_nilOO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[5] : wire_nl01l_dataout;
	assign		wire_nilOOi_dataout = ((~ nilOO0O) === 1'b1) ? n01OlO : n01liO;
	assign		wire_nilOOl_dataout = ((~ nilOO0O) === 1'b1) ? n01OOi : n01lli;
	assign		wire_nilOOO_dataout = ((~ nilOO0O) === 1'b1) ? n01OOl : n01lll;
	assign		wire_niO00ll_dataout = (nilO1lO === 1'b1) ? nilO1Oi : wire_niO00lO_dataout;
	assign		wire_niO00lO_dataout = (nilO0ii === 1'b1) ? niO0lOl : niO000i;
	assign		wire_niO0i_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[9] : wire_nl00O_dataout;
	assign		wire_niO0i0i_dataout = (nilO0ii === 1'b1) ? niO0lOi : niO00Ol;
	or(wire_niO0i0l_dataout, fftpts_in[2], fftpts_in[1]);
	or(wire_niO0i0O_dataout, fftpts_in[4], fftpts_in[3]);
	assign		wire_niO0i1i_dataout = (nilO1lO === 1'b1) ? wire_niO0i0O_dataout : wire_niO0i1O_dataout;
	assign		wire_niO0i1l_dataout = (nilO1lO === 1'b1) ? wire_niO0i0l_dataout : wire_niO0i0i_dataout;
	assign		wire_niO0i1O_dataout = (nilO0ii === 1'b1) ? niO0llO : niO00li;
	assign		wire_niO0ii_dataout = (nilOOii === 1'b1) ? wire_niOi0i_dataout : wire_niO0li_dataout;
	assign		wire_niO0iil_dataout = (nilO1lO === 1'b1) ? inverse[0] : wire_niO0iiO_dataout;
	assign		wire_niO0iiO_dataout = (nilO0ii === 1'b1) ? niO0iOl : niO00OO;
	assign		wire_niO0il_dataout = (nilOOii === 1'b1) ? wire_niOi0l_dataout : wire_niO0ll_dataout;
	assign		wire_niO0iO_dataout = (nilOOii === 1'b1) ? wire_niOi0O_dataout : wire_niO0lO_dataout;
	assign		wire_niO0iOO_dataout = (nilO1lO === 1'b1) ? fftpts_in[0] : wire_niO0l0l_dataout;
	assign		wire_niO0l_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[10] : wire_nl0ii_dataout;
	assign		wire_niO0l0i_dataout = (nilO1lO === 1'b1) ? fftpts_in[4] : wire_niO0liO_dataout;
	assign		wire_niO0l0l_dataout = (nilO0ii === 1'b1) ? niO0lOO : niO0iii;
	assign		wire_niO0l0O_dataout = (nilO0ii === 1'b1) ? niO0O1i : niO0ili;
	assign		wire_niO0l1i_dataout = (nilO1lO === 1'b1) ? fftpts_in[1] : wire_niO0l0O_dataout;
	assign		wire_niO0l1l_dataout = (nilO1lO === 1'b1) ? fftpts_in[2] : wire_niO0lii_dataout;
	assign		wire_niO0l1O_dataout = (nilO1lO === 1'b1) ? fftpts_in[3] : wire_niO0lil_dataout;
	assign		wire_niO0li_dataout = (nilOOil === 1'b1) ? wire_niO0Oi_dataout : niO01l;
	assign		wire_niO0lii_dataout = (nilO0ii === 1'b1) ? niO0O1l : niO0ill;
	assign		wire_niO0lil_dataout = (nilO0ii === 1'b1) ? niO0O1O : niO0ilO;
	assign		wire_niO0liO_dataout = (nilO0ii === 1'b1) ? niO0O0l : niO0iOi;
	assign		wire_niO0ll_dataout = (nilOOil === 1'b1) ? wire_niO0Ol_dataout : niO00l;
	assign		wire_niO0lO_dataout = (nilOOil === 1'b1) ? wire_niO0OO_dataout : niO00O;
	assign		wire_niO0O_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[11] : wire_nl0il_dataout;
	assign		wire_niO0Oi_dataout = ((~ nilOOii) === 1'b1) ? wire_niOi1i_o[1] : niO01l;
	assign		wire_niO0Ol_dataout = ((~ nilOOii) === 1'b1) ? wire_niOi1i_o[2] : niO00l;
	assign		wire_niO0OO_dataout = ((~ nilOOii) === 1'b1) ? wire_niOi1i_o[3] : niO00O;
	and(wire_niO0OOi_dataout, wire_niOi11l_o[0], ~(nilO0li));
	and(wire_niO0OOl_dataout, wire_niOi11l_o[1], ~(nilO0li));
	and(wire_niO0OOO_dataout, wire_niOi11l_o[2], ~(nilO0li));
	assign		wire_niO10i_dataout = ((~ nilOO0O) === 1'b1) ? n0011O : n01lOO;
	assign		wire_niO10l_dataout = ((~ nilOO0O) === 1'b1) ? n0010i : n01O1i;
	assign		wire_niO10O_dataout = ((~ nilOO0O) === 1'b1) ? n0010l : n01O1l;
	assign		wire_niO11i_dataout = ((~ nilOO0O) === 1'b1) ? n01OOO : n01llO;
	assign		wire_niO11l_dataout = ((~ nilOO0O) === 1'b1) ? n0011i : n01lOi;
	assign		wire_niO11O_dataout = ((~ nilOO0O) === 1'b1) ? n0011l : n01lOl;
	assign		wire_niO1i_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[6] : wire_nl01O_dataout;
	assign		wire_niO1ii_dataout = ((~ nilOO0O) === 1'b1) ? n0010O : n01O1O;
	assign		wire_niO1il_dataout = ((~ nilOO0O) === 1'b1) ? n001ii : n01O0i;
	assign		wire_niO1iO_dataout = ((~ nilOO0O) === 1'b1) ? n001il : n01O0l;
	assign		wire_niO1l_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[7] : wire_nl00i_dataout;
	assign		wire_niO1li_dataout = ((~ nilOO0O) === 1'b1) ? n001iO : n01O0O;
	assign		wire_niO1ll_dataout = ((~ nilOO0O) === 1'b1) ? n001li : n01Oii;
	assign		wire_niO1lO_dataout = ((~ nilOO0O) === 1'b1) ? n001ll : n01Oil;
	assign		wire_niO1O_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[8] : wire_nl00l_dataout;
	assign		wire_niO1Oi_dataout = ((~ nilOO0O) === 1'b1) ? n001lO : n01OiO;
	assign		wire_niO1Ol_dataout = ((~ nilOO0O) === 1'b1) ? n001Oi : n01Oli;
	assign		wire_niO1OO_dataout = ((~ nilOO0O) === 1'b1) ? n001Ol : n01Oll;
	assign		wire_niOi0i_dataout = ((~ nilOOil) === 1'b1) ? wire_niOiii_o[0] : niO01l;
	and(wire_niOi0iO_dataout, wire_niOi0ll_dataout, ~((nilO00l & nilO01l)));
	assign		wire_niOi0l_dataout = ((~ nilOOil) === 1'b1) ? wire_niOiii_o[1] : niO00l;
	or(wire_niOi0ll_dataout, niOi00l, (sink_sop & nilO00l));
	assign		wire_niOi0O_dataout = ((~ nilOOil) === 1'b1) ? wire_niOiii_o[2] : niO00O;
	or(wire_niOi0OO_dataout, wire_niOii1l_dataout, niOi01l);
	and(wire_niOi11i_dataout, wire_niOi11l_o[3], ~(nilO0li));
	and(wire_niOi1il_dataout, wire_niOi1lO_o[0], ~(nilO01i));
	and(wire_niOi1iO_dataout, wire_niOi1lO_o[1], ~(nilO01i));
	and(wire_niOi1li_dataout, wire_niOi1lO_o[2], ~(nilO01i));
	and(wire_niOi1ll_dataout, wire_niOi1lO_o[3], ~(nilO01i));
	assign		wire_niOii_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[12] : wire_nl0iO_dataout;
	...
	assign		wire_niOil_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[13] : wire_nl0li_dataout;
	...
	assign		wire_niOiO_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[14] : wire_nl0ll_dataout;
	assign		wire_niOiOi_dataout = (niO000i === 1'b1) ? n01llO : ni0i1l;
	assign		wire_niOiOii_dataout = (nilO00O === 1'b1) ? nilO01O : wire_niOiOil_dataout;
	and(wire_niOiOil_dataout, nilO01O, nilO00i);
	assign		wire_niOiOiO_dataout = (nilO00O === 1'b1) ? niOiO0O : wire_niOl0ll_dataout;
	assign		wire_niOiOl_dataout = (niO000i === 1'b1) ? n01lOi : ni0i1O;
	assign		wire_niOiOli_dataout = (nilO00O === 1'b1) ? niOlO1i : wire_niOl0lO_dataout;
	assign		wire_niOiOll_dataout = (nilO00O === 1'b1) ? niOlO1l : wire_niOl0Oi_dataout;
	assign		wire_niOiOlO_dataout = (nilO00O === 1'b1) ? niOlO1O : wire_niOl0Ol_dataout;
	assign		wire_niOiOO_dataout = (niO000i === 1'b1) ? n01lOl : ni0i0i;
	assign		wire_niOiOOi_dataout = (nilO00O === 1'b1) ? niOlO0i : wire_niOl0OO_dataout;
	assign		wire_niOiOOl_dataout = (nilO00O === 1'b1) ? niOlO0l : wire_niOli1i_dataout;
	assign		wire_niOiOOO_dataout = (nilO00O === 1'b1) ? niOlO0O : wire_niOli1l_dataout;
	assign		wire_niOl00i_dataout = (nilO00O === 1'b1) ? niOO1li : wire_niOll0O_dataout;
	assign		wire_niOl00l_dataout = (nilO00O === 1'b1) ? niOO1ll : wire_niOllii_dataout;
	assign		wire_niOl00O_dataout = (nilO00O === 1'b1) ? niOO1lO : wire_niOllil_dataout;
	assign		wire_niOl01i_dataout = (nilO00O === 1'b1) ? niOO1ii : wire_niOll1O_dataout;
	assign		wire_niOl01l_dataout = (nilO00O === 1'b1) ? niOO1il : wire_niOll0i_dataout;
	assign		wire_niOl01O_dataout = (nilO00O === 1'b1) ? niOO1iO : wire_niOll0l_dataout;
	assign		wire_niOl0i_dataout = (niO000i === 1'b1) ? n01O1O : ni0iil;
	assign		wire_niOl0ii_dataout = (nilO00O === 1'b1) ? niOO1Oi : wire_niOlliO_dataout;
	assign		wire_niOl0il_dataout = (nilO00O === 1'b1) ? niOO1Ol : wire_niOllli_dataout;
	assign		wire_niOl0iO_dataout = (nilO00O === 1'b1) ? niOO1OO : wire_niOllll_dataout;
	assign		wire_niOl0l_dataout = (niO000i === 1'b1) ? n01O0i : ni0iiO;
	assign		wire_niOl0li_dataout = (nilO00O === 1'b1) ? niOO01l : wire_niOlllO_dataout;
	assign		wire_niOl0ll_dataout = (nilO00i === 1'b1) ? sink_real[0] : niOii0i;
	assign		wire_niOl0lO_dataout = (nilO00i === 1'b1) ? sink_real[1] : niOii0l;
	assign		wire_niOl0O_dataout = (niO000i === 1'b1) ? n01O0l : ni0ili;
	assign		wire_niOl0Oi_dataout = (nilO00i === 1'b1) ? sink_real[2] : niOii0O;
	assign		wire_niOl0Ol_dataout = (nilO00i === 1'b1) ? sink_real[3] : niOiiii;
	assign		wire_niOl0OO_dataout = (nilO00i === 1'b1) ? sink_real[4] : niOiiil;
	assign		wire_niOl10i_dataout = (nilO00O === 1'b1) ? niOlOli : wire_niOli0O_dataout;
	assign		wire_niOl10l_dataout = (nilO00O === 1'b1) ? niOlOll : wire_niOliii_dataout;
	assign		wire_niOl10O_dataout = (nilO00O === 1'b1) ? niOlOlO : wire_niOliil_dataout;
	assign		wire_niOl11i_dataout = (nilO00O === 1'b1) ? niOlOii : wire_niOli1O_dataout;
	assign		wire_niOl11l_dataout = (nilO00O === 1'b1) ? niOlOil : wire_niOli0i_dataout;
	assign		wire_niOl11O_dataout = (nilO00O === 1'b1) ? niOlOiO : wire_niOli0l_dataout;
	assign		wire_niOl1i_dataout = (niO000i === 1'b1) ? n01lOO : ni0i0l;
	assign		wire_niOl1ii_dataout = (nilO00O === 1'b1) ? niOlOOi : wire_niOliiO_dataout;
	assign		wire_niOl1il_dataout = (nilO00O === 1'b1) ? niOlOOl : wire_niOlili_dataout;
	assign		wire_niOl1iO_dataout = (nilO00O === 1'b1) ? niOlOOO : wire_niOlill_dataout;
	assign		wire_niOl1l_dataout = (niO000i === 1'b1) ? n01O1i : ni0i0O;
	assign		wire_niOl1li_dataout = (nilO00O === 1'b1) ? niOO11i : wire_niOlilO_dataout;
	assign		wire_niOl1ll_dataout = (nilO00O === 1'b1) ? niOO11l : wire_niOliOi_dataout;
	assign		wire_niOl1lO_dataout = (nilO00O === 1'b1) ? niOO11O : wire_niOliOl_dataout;
	assign		wire_niOl1O_dataout = (niO000i === 1'b1) ? n01O1l : ni0iii;
	assign		wire_niOl1Oi_dataout = (nilO00O === 1'b1) ? niOO10i : wire_niOliOO_dataout;
	assign		wire_niOl1Ol_dataout = (nilO00O === 1'b1) ? niOO10l : wire_niOll1i_dataout;
	assign		wire_niOl1OO_dataout = (nilO00O === 1'b1) ? niOO10O : wire_niOll1l_dataout;
	assign		wire_niOli_dataout = (niO1i1O === 1'b1) ? wire_nlOi1O_q_b[15] : wire_nl0lO_dataout;
	assign		wire_niOli0i_dataout = (nilO00i === 1'b1) ? sink_real[8] : niOiilO;
	assign		wire_niOli0l_dataout = (nilO00i === 1'b1) ? sink_real[9] : niOiiOi;
	assign		wire_niOli0O_dataout = (nilO00i === 1'b1) ? sink_real[10] : niOiiOl;
	assign		wire_niOli1i_dataout = (nilO00i === 1'b1) ? sink_real[5] : niOiiiO;
	assign		wire_niOli1l_dataout = (nilO00i === 1'b1) ? sink_real[6] : niOiili;
	assign		wire_niOli1O_dataout = (nilO00i === 1'b1) ? sink_real[7] : niOiill;
	assign		wire_niOlii_dataout = (niO000i === 1'b1) ? n01O0O : ni0ill;
	assign		wire_niOliii_dataout = (nilO00i === 1'b1) ? sink_real[11] : niOiiOO;
	assign		wire_niOliil_dataout = (nilO00i === 1'b1) ? sink_real[12] : niOil1i;
	assign		wire_niOliiO_dataout = (nilO00i === 1'b1) ? sink_real[13] : niOil1l;
	assign		wire_niOlil_dataout = (niO000i === 1'b1) ? n01Oii : ni0ilO;
	assign		wire_niOlili_dataout = (nilO00i === 1'b1) ? sink_real[14] : niOil1O;
	assign		wire_niOlill_dataout = (nilO00i === 1'b1) ? sink_real[15] : niOil0i;
	assign		wire_niOlilO_dataout = (nilO00i === 1'b1) ? sink_imag[0] : niOil0l;
	assign		wire_niOliO_dataout = (niO000i === 1'b1) ? n01Oil : ni0iOi;
	assign		wire_niOliOi_dataout = (nilO00i === 1'b1) ? sink_imag[1] : niOil0O;
	assign		wire_niOliOl_dataout = (nilO00i === 1'b1) ? sink_imag[2] : niOilii;
	assign		wire_niOliOO_dataout = (nilO00i === 1'b1) ? sink_imag[3] : niOilil;
	assign		wire_niOll_dataout = (niO10OO === 1'b1) ? ni11O : n1l0O;
	assign		wire_niOll0i_dataout = (nilO00i === 1'b1) ? sink_imag[7] : niOillO;
	assign		wire_niOll0l_dataout = (nilO00i === 1'b1) ? sink_imag[8] : niOilOi;
	assign		wire_niOll0O_dataout = (nilO00i === 1'b1) ? sink_imag[9] : niOilOl;
	assign		wire_niOll1i_dataout = (nilO00i === 1'b1) ? sink_imag[4] : niOiliO;
	assign		wire_niOll1l_dataout = (nilO00i === 1'b1) ? sink_imag[5] : niOilli;
	assign		wire_niOll1O_dataout = (nilO00i === 1'b1) ? sink_imag[6] : niOilll;
	assign		wire_niOlli_dataout = (niO000i === 1'b1) ? n01OiO : ni0iOl;
	assign		wire_niOllii_dataout = (nilO00i === 1'b1) ? sink_imag[10] : niOilOO;
	assign		wire_niOllil_dataout = (nilO00i === 1'b1) ? sink_imag[11] : niOiO1i;
	assign		wire_niOlliO_dataout = (nilO00i === 1'b1) ? sink_imag[12] : niOiO1l;
	assign		wire_niOlll_dataout = (niO000i === 1'b1) ? n01Oli : ni0iOO;
	assign		wire_niOllli_dataout = (nilO00i === 1'b1) ? sink_imag[13] : niOiO1O;
	assign		wire_niOllll_dataout = (nilO00i === 1'b1) ? sink_imag[14] : niOiO0i;
	assign		wire_niOlllO_dataout = (nilO00i === 1'b1) ? sink_imag[15] : niOiO0l;
	assign		wire_niOllO_dataout = (niO000i === 1'b1) ? n01Oll : ni0l1i;
	assign		wire_niOlO_dataout = (niO10OO === 1'b1) ? ni10i : n0l1l;
	...
	assign		wire_niOO0ll_dataout = ((~ niOO01O) === 1'b1) ? ((sink_valid & nilO0iO) & (~ nll1i)) : (~ ((~ nll0O) & (~ nll1i)));
	...
	assign		wire_niOOi_dataout = (niO10OO === 1'b1) ? ni10l : n0l1O;
	...
	assign		wire_niOOl_dataout = (niO10OO === 1'b1) ? ni10O : n0l0i;
	...
	assign		wire_niOOO_dataout = (niO10OO === 1'b1) ? ni1ii : n0l0l;
	assign		wire_niOOOi_dataout = (niO000i === 1'b1) ? n001Ol : ni0O1l;
	and(wire_niOOOO_dataout, nll00li, ~(niO00Ol));
	and(wire_nl0000i_dataout, nl001ii, ~(nilOi1O));
	assign		wire_nl0000l_dataout = (nilOi0i === 1'b1) ? wire_nl00i0l_o[0] : wire_nl000li_dataout;
	assign		wire_nl0000O_dataout = (nilOi0i === 1'b1) ? wire_nl00i0l_o[1] : wire_nl000ll_dataout;
	and(wire_nl0001i_dataout, nilOi1O, ~(nilOi0i));
	assign		wire_nl0001l_dataout = (nilOi0i === 1'b1) ? nl11OiO : nl00iii;
	or(wire_nl0001O_dataout, wire_nl0000i_dataout, nilOi0i);
	assign		wire_nl000i_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[1] : wire_nl110i_q_a[0];
	assign		wire_nl000ii_dataout = (nilOi0i === 1'b1) ? wire_nl00i0l_o[2] : wire_nl000lO_dataout;
	assign		wire_nl000il_dataout = (nilOi0i === 1'b1) ? wire_nl00i0l_o[3] : wire_nl000Oi_dataout;
	assign		wire_nl000iO_dataout = (nilOi0i === 1'b1) ? wire_nl00i0l_o[4] : wire_nl000Ol_dataout;
	assign		wire_nl000l_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[2] : wire_nl110i_q_a[1];
	and(wire_nl000li_dataout, wire_nl000OO_dataout, ~(nilOi1O));
	and(wire_nl000ll_dataout, wire_nl00i1i_dataout, ~(nilOi1O));
	and(wire_nl000lO_dataout, wire_nl00i1l_dataout, ~(nilOi1O));
	assign		wire_nl000O_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[3] : wire_nl110i_q_a[2];
	and(wire_nl000Oi_dataout, wire_nl00i1O_dataout, ~(nilOi1O));
	and(wire_nl000Ol_dataout, wire_nl00i0i_dataout, ~(nilOi1O));
	assign		wire_nl000OO_dataout = (wire_nl00i0O_o === 1'b1) ? wire_nl00i0l_o[0] : nl001li;
	or(wire_nl001i_dataout, wire_nl0i1l_dataout, nilOOli);
	or(wire_nl001l_dataout, wire_nl0i1O_dataout, nilOOli);
	and(wire_nl001O_dataout, wire_nl0i0i_dataout, ~(nilOOli));
	assign		wire_nl00i_dataout = (niO10OO === 1'b1) ? ni0ll : n0OiO;
	...
	assign		wire_nl00ii_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[4] : wire_nl110i_q_a[3];
	assign		wire_nl00il_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[5] : wire_nl110i_q_a[4];
	assign		wire_nl00iO_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[6] : wire_nl110i_q_a[5];
	assign		wire_nl00l_dataout = (niO10OO === 1'b1) ? ni0lO : n0Oli;
	...
	and(wire_nl00l0O_dataout, wire_nl00lll_o[0], ~(nilOi0O));
	...
	assign		wire_nl00li_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[7] : wire_nl110i_q_a[6];
	and(wire_nl00lii_dataout, wire_nl00lll_o[1], ~(nilOi0O));
	and(wire_nl00lil_dataout, wire_nl00lll_o[2], ~(nilOi0O));
	and(wire_nl00liO_dataout, wire_nl00lll_o[3], ~(nilOi0O));
	assign		wire_nl00ll_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[8] : wire_nl110i_q_a[7];
	and(wire_nl00lli_dataout, wire_nl00lll_o[4], ~(nilOi0O));
	assign		wire_nl00lO_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[9] : wire_nl110i_q_a[8];
	assign		wire_nl00O_dataout = (niO10OO === 1'b1) ? ni0Oi : n0Oll;
	assign		wire_nl00Oi_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[10] : wire_nl110i_q_a[9];
	...
	assign		wire_nl00Ol_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[11] : wire_nl110i_q_a[10];
	...
	assign		wire_nl00OO_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[12] : wire_nl110i_q_a[11];
	or(wire_nl010i_dataout, wire_nl000l_dataout, nilOOli);
	or(wire_nl010l_dataout, wire_nl000O_dataout, nilOOli);
	or(wire_nl010O_dataout, wire_nl00ii_dataout, nilOOli);
	or(wire_nl011O_dataout, wire_nl000i_dataout, nilOOli);
	assign		wire_nl01i_dataout = (niO10OO === 1'b1) ? ni0il : n0O0O;
	or(wire_nl01ii_dataout, wire_nl00il_dataout, nilOOli);
	or(wire_nl01il_dataout, wire_nl00iO_dataout, nilOOli);
	or(wire_nl01iO_dataout, wire_nl00li_dataout, nilOOli);
	assign		wire_nl01l_dataout = (niO10OO === 1'b1) ? ni0iO : n0Oii;
	...
	or(wire_nl01li_dataout, wire_nl00ll_dataout, nilOOli);
	...
	or(wire_nl01ll_dataout, wire_nl00lO_dataout, nilOOli);
	assign		wire_nl01lli_dataout = (niO000i === 1'b1) ? wire_nl01llO_o[2] : wire_nl01lll_o[3];
	or(wire_nl01lO_dataout, wire_nl00Oi_dataout, nilOOli);
	...
	assign		wire_nl01O_dataout = (niO10OO === 1'b1) ? ni0li : n0Oil;
	assign		wire_nl01O1i_dataout = (niO000i === 1'b1) ? wire_nl01O1O_o[2] : wire_nl01O1l_o[3];
	or(wire_nl01Oi_dataout, wire_nl00Ol_dataout, nilOOli);
	or(wire_nl01Ol_dataout, wire_nl00OO_dataout, nilOOli);
	or(wire_nl01OO_dataout, wire_nl0i1i_dataout, nilOOli);
	assign		wire_nl0i0i_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[32] : wire_nl110i_q_a[15];
	assign		wire_nl0i1i_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[13] : wire_nl110i_q_a[12];
	assign		wire_nl0i1l_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[14] : wire_nl110i_q_a[13];
	assign		wire_nl0i1O_dataout = (nilOOll === 1'b1) ? wire_nl0i0l_o[15] : wire_nl110i_q_a[14];
	assign		wire_nl0ii_dataout = (niO10OO === 1'b1) ? ni0Ol : n0OlO;
	...
	assign		wire_nl0il_dataout = (niO10OO === 1'b1) ? ni0OO : n0OOi;
	...
	assign		wire_nl0iO_dataout = (niO10OO === 1'b1) ? nii1i : n0OOl;
	...
	assign		wire_nl0li_dataout = (niO10OO === 1'b1) ? nii1l : n0OOO;
	assign		wire_nl0ll_dataout = (niO10OO === 1'b1) ? nii1O : ni11i;
	assign		wire_nl0lO_dataout = (niO10OO === 1'b1) ? nii0l : ni11l;
	and(wire_nl0lOi_dataout, wire_nl0O1l_dataout, ~(niO111i));
	and(wire_nl0lOl_dataout, wire_nl0O1O_dataout, ~(niO111i));
	and(wire_nl0lOO_dataout, wire_nl0O0i_dataout, ~(niO111i));
	...
	and(wire_nl0O1i_dataout, wire_nl0O0l_dataout, ~(niO111i));
	...
	assign		wire_nl10i_dataout = (niO10OO === 1'b1) ? ni1ll : n0liO;
	...
	assign		wire_nl10l_dataout = (niO10OO === 1'b1) ? ni1lO : n0lli;
	...
	assign		wire_nl10O_dataout = (niO10OO === 1'b1) ? ni1Oi : n0lll;
	...
	and(wire_nl1100i_dataout, wire_nl110iO_dataout, ~(nilO0lO));
	and(wire_nl1100l_dataout, wire_nl110li_dataout, ~(nilO0lO));
	and(wire_nl1100O_dataout, wire_nl110ll_dataout, ~(nilO0lO));
	assign		wire_nl1101i_dataout = (nilO0Oi === 1'b1) ? wire_nl110Oi_o[3] : wire_nl1100O_dataout;
	assign		wire_nl1101l_dataout = (nilO0Oi === 1'b1) ? wire_nl110Oi_o[4] : wire_nl110ii_dataout;
	and(wire_nl1101O_dataout, wire_nl110il_dataout, ~(nilO0lO));
	and(wire_nl110ii_dataout, wire_nl110lO_dataout, ~(nilO0lO));
	...
	and(wire_nl111iO_dataout, nilO0lO, ~(nilO0Oi));
	and(wire_nl111l_dataout, nll010l, ~(niO00Ol));
	assign		wire_nl111li_dataout = (nilO0Oi === 1'b1) ? wire_nliiiO_dataout : nl110OO;
	or(wire_nl111ll_dataout, wire_nl111lO_dataout, nilO0Oi);
	and(wire_nl111lO_dataout, niOOOOO, ~(nilO0lO));
	and(wire_nl111O_dataout, nll010O, ~(niO00Ol));
	assign		wire_nl111Oi_dataout = (nilO0Oi === 1'b1) ? wire_nl110Oi_o[0] : wire_nl1101O_dataout;
	assign		wire_nl111Ol_dataout = (nilO0Oi === 1'b1) ? wire_nl110Oi_o[1] : wire_nl1100i_dataout;
	assign		wire_nl111OO_dataout = (nilO0Oi === 1'b1) ? wire_nl110Oi_o[2] : wire_nl1100l_dataout;
	assign		wire_nl11i_dataout = (niO10OO === 1'b1) ? ni1il : n0l0O;
	...
	and(wire_nl11iOl_dataout, wire_nl11l0i_o[0], ~(nilO0OO));
	and(wire_nl11iOO_dataout, wire_nl11l0i_o[1], ~(nilO0OO));
	assign		wire_nl11l_dataout = (niO10OO === 1'b1) ? ni1iO : n0lii;
	and(wire_nl11l1i_dataout, wire_nl11l0i_o[2], ~(nilO0OO));
	and(wire_nl11l1l_dataout, wire_nl11l0i_o[3], ~(nilO0OO));
	and(wire_nl11l1O_dataout, wire_nl11l0i_o[4], ~(nilO0OO));
	assign		wire_nl11O_dataout = (niO10OO === 1'b1) ? ni1li : n0lil;
	...
	assign		wire_nl1ii_dataout = (niO10OO === 1'b1) ? ni1Ol : n0llO;
	assign		wire_nl1il_dataout = (niO10OO === 1'b1) ? ni1OO : n0lOi;
	assign		wire_nl1iO_dataout = (niO10OO === 1'b1) ? ni01i : n0lOl;
	and(wire_nl1iOi_dataout, wire_nl1lOl_dataout, ~(nilOOli));
	and(wire_nl1iOl_dataout, wire_nl1lOO_dataout, ~(nilOOli));
	and(wire_nl1iOO_dataout, wire_nl1O1i_dataout, ~(nilOOli));
	and(wire_nl1l0i_dataout, wire_nl1O0l_dataout, ~(nilOOli));
	and(wire_nl1l0l_dataout, wire_nl1O0O_dataout, ~(nilOOli));
	and(wire_nl1l0O_dataout, wire_nl1Oii_dataout, ~(nilOOli));
	and(wire_nl1l1i_dataout, wire_nl1O1l_dataout, ~(nilOOli));
	and(wire_nl1l1l_dataout, wire_nl1O1O_dataout, ~(nilOOli));
	and(wire_nl1l1O_dataout, wire_nl1O0i_dataout, ~(nilOOli));
	assign		wire_nl1li_dataout = (niO10OO === 1'b1) ? ni01l : n0lOO;
	and(wire_nl1lii_dataout, wire_nl1Oil_dataout, ~(nilOOli));
	and(wire_nl1lil_dataout, wire_nl1OiO_dataout, ~(nilOOli));
	and(wire_nl1liO_dataout, wire_nl1Oli_dataout, ~(nilOOli));
	assign		wire_nl1ll_dataout = (niO10OO === 1'b1) ? ni01O : n0O1i;
	and(wire_nl1lli_dataout, wire_nl1Oll_dataout, ~(nilOOli));
	and(wire_nl1lll_dataout, wire_nl1OlO_dataout, ~(nilOOli));
	and(wire_nl1llO_dataout, wire_nl1OOi_dataout, ~(nilOOli));
	assign		wire_nl1lO_dataout = (niO10OO === 1'b1) ? ni00i : n0O1l;
	and(wire_nl1lOi_dataout, wire_nl1OOl_dataout, ~(nilOOli));
	assign		wire_nl1lOl_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[1] : wire_nl110i_q_b[0];
	assign		wire_nl1lOO_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[2] : wire_nl110i_q_b[1];
	...
	assign		wire_nl1O0i_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[6] : wire_nl110i_q_b[5];
	...
	assign		wire_nl1O0l_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[7] : wire_nl110i_q_b[6];
	...
	assign		wire_nl1O0O_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[8] : wire_nl110i_q_b[7];
	...
	assign		wire_nl1O1i_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[3] : wire_nl110i_q_b[2];
	assign		wire_nl1O1l_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[4] : wire_nl110i_q_b[3];
	assign		wire_nl1O1O_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[5] : wire_nl110i_q_b[4];
	...
	assign		wire_nl1Oi_dataout = (niO10OO === 1'b1) ? ni00l : n0O1O;
	...
	assign		wire_nl1Oii_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[9] : wire_nl110i_q_b[8];
	...
	assign		wire_nl1Oil_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[10] : wire_nl110i_q_b[9];
	...
	assign		wire_nl1OiO_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[11] : wire_nl110i_q_b[10];
	...
	assign		wire_nl1Ol_dataout = (niO10OO === 1'b1) ? ni00O : n0O0i;
	...
	assign		wire_nl1Oli_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[12] : wire_nl110i_q_b[11];
	assign		wire_nl1Oll_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[13] : wire_nl110i_q_b[12];
	assign		wire_nl1OlO_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[14] : wire_nl110i_q_b[13];
	assign		wire_nl1OO_dataout = (niO10OO === 1'b1) ? ni0ii : n0O0l;
	assign		wire_nl1OOi_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[15] : wire_nl110i_q_b[14];
	assign		wire_nl1OOl_dataout = (nilOOiO === 1'b1) ? wire_nl1OOO_o[32] : wire_nl110i_q_b[15];
	assign		wire_nli00i_dataout = ((~ niO111O) === 1'b1) ? wire_niOlll_dataout : wire_niOOlO_dataout;
	assign		wire_nli00l_dataout = ((~ niO111O) === 1'b1) ? wire_niOllO_dataout : wire_niOOOi_dataout;
	assign		wire_nli00O_dataout = ((~ niO111O) === 1'b1) ? wire_niOlOi_dataout : wire_niOilO_dataout;
	assign		wire_nli01i_dataout = ((~ niO111O) === 1'b1) ? wire_niOlil_dataout : wire_niOOiO_dataout;
	assign		wire_nli01l_dataout = ((~ niO111O) === 1'b1) ? wire_niOliO_dataout : wire_niOOli_dataout;
	assign		wire_nli01O_dataout = ((~ niO111O) === 1'b1) ? wire_niOlli_dataout : wire_niOOll_dataout;
	assign		wire_nli0ii_dataout = ((~ niO111O) === 1'b1) ? wire_niOlOl_dataout : wire_niOiOi_dataout;
	assign		wire_nli0il_dataout = ((~ niO111O) === 1'b1) ? wire_niOlOO_dataout : wire_niOiOl_dataout;
	assign		wire_nli0iO_dataout = ((~ niO111O) === 1'b1) ? wire_niOO1i_dataout : wire_niOiOO_dataout;
	assign		wire_nli0li_dataout = ((~ niO111O) === 1'b1) ? wire_niOO1l_dataout : wire_niOl1i_dataout;
	assign		wire_nli0ll_dataout = ((~ niO111O) === 1'b1) ? wire_niOO1O_dataout : wire_niOl1l_dataout;
	assign		wire_nli0lO_dataout = ((~ niO111O) === 1'b1) ? wire_niOO0i_dataout : wire_niOl1O_dataout;
	assign		wire_nli0Oi_dataout = ((~ niO111O) === 1'b1) ? wire_niOO0l_dataout : wire_niOl0i_dataout;
	assign		wire_nli0Ol_dataout = ((~ niO111O) === 1'b1) ? wire_niOO0O_dataout : wire_niOl0l_dataout;
	assign		wire_nli0OO_dataout = ((~ niO111O) === 1'b1) ? wire_niOOii_dataout : wire_niOl0O_dataout;
	assign		wire_nli10l_dataout = ((~ niO111O) === 1'b1) ? wire_niOilO_dataout : wire_niOlOi_dataout;
	assign		wire_nli10O_dataout = ((~ niO111O) === 1'b1) ? wire_niOiOi_dataout : wire_niOlOl_dataout;
	or(wire_nli11i_dataout, wire_nli11O_dataout, nl0llO);
	or(wire_nli11l_dataout, wire_nl111l_dataout, (~ niO111l));
	or(wire_nli11O_dataout, wire_nl111O_dataout, (~ niO111l));
	assign		wire_nli1ii_dataout = ((~ niO111O) === 1'b1) ? wire_niOiOl_dataout : wire_niOlOO_dataout;
	assign		wire_nli1il_dataout = ((~ niO111O) === 1'b1) ? wire_niOiOO_dataout : wire_niOO1i_dataout;
	assign		wire_nli1iO_dataout = ((~ niO111O) === 1'b1) ? wire_niOl1i_dataout : wire_niOO1l_dataout;
	assign		wire_nli1li_dataout = ((~ niO111O) === 1'b1) ? wire_niOl1l_dataout : wire_niOO1O_dataout;
	assign		wire_nli1ll_dataout = ((~ niO111O) === 1'b1) ? wire_niOl1O_dataout : wire_niOO0i_dataout;
	assign		wire_nli1lO_dataout = ((~ niO111O) === 1'b1) ? wire_niOl0i_dataout : wire_niOO0l_dataout;
	assign		wire_nli1Oi_dataout = ((~ niO111O) === 1'b1) ? wire_niOl0l_dataout : wire_niOO0O_dataout;
	assign		wire_nli1Ol_dataout = ((~ niO111O) === 1'b1) ? wire_niOl0O_dataout : wire_niOOii_dataout;
	assign		wire_nli1OO_dataout = ((~ niO111O) === 1'b1) ? wire_niOlii_dataout : wire_niOOil_dataout;
	...
	assign		wire_nlii0i_dataout = ((~ niO111O) === 1'b1) ? wire_niOOll_dataout : wire_niOlli_dataout;
	...
	assign		wire_nlii0l_dataout = ((~ niO111O) === 1'b1) ? wire_niOOlO_dataout : wire_niOlll_dataout;
	...
	assign		wire_nlii0O_dataout = ((~ niO111O) === 1'b1) ? wire_niOOOi_dataout : wire_niOllO_dataout;
	...
	assign		wire_nlii1i_dataout = ((~ niO111O) === 1'b1) ? wire_niOOil_dataout : wire_niOlii_dataout;
	...
	assign		wire_nlii1l_dataout = ((~ niO111O) === 1'b1) ? wire_niOOiO_dataout : wire_niOlil_dataout;
	...
	assign		wire_nlii1O_dataout = ((~ niO111O) === 1'b1) ? wire_niOOli_dataout : wire_niOliO_dataout;
	...
	and(wire_nliili_dataout, niO110i, niO00li);
	...
	assign		wire_nlilOlO_dataout = ((~ nilOiil) === 1'b1) ? nl1011i : nl1001O;
	and(wire_nlilOO_dataout, wire_nll01l_dataout, niO00li);
	assign		wire_nlilOOi_dataout = ((~ nilOiil) === 1'b1) ? nl1011l : nl1000i;
	assign		wire_nlilOOl_dataout = ((~ nilOiil) === 1'b1) ? nl1011O : nl1000l;
	assign		wire_nlilOOO_dataout = ((~ nilOiil) === 1'b1) ? nl1010i : nl1000O;
	assign		wire_nliO00i_dataout = ((~ nilOiil) === 1'b1) ? nl100il : nl1010O;
	assign		wire_nliO00l_dataout = ((~ nilOiil) === 1'b1) ? nl100iO : nl101ii;
	assign		wire_nliO00O_dataout = ((~ nilOiil) === 1'b1) ? nl100li : nl101il;
	assign		wire_nliO01i_dataout = ((~ nilOiil) === 1'b1) ? nl1000l : nl1011O;
	assign		wire_nliO01l_dataout = ((~ nilOiil) === 1'b1) ? nl1000O : nl1010i;
	assign		wire_nliO01O_dataout = ((~ nilOiil) === 1'b1) ? nl100ii : nl1010l;
	and(wire_nliO0i_dataout, wire_nll00O_dataout, niO00li);
	assign		wire_nliO0ii_dataout = ((~ nilOiil) === 1'b1) ? nl100ll : nl101iO;
	assign		wire_nliO0il_dataout = ((~ nilOiil) === 1'b1) ? nl100lO : nl101li;
	assign		wire_nliO0iO_dataout = ((~ nilOiil) === 1'b1) ? nl100Oi : nl101ll;
	and(wire_nliO0l_dataout, wire_nll0ii_dataout, niO00li);
	assign		wire_nliO0li_dataout = ((~ nilOiil) === 1'b1) ? nl100Ol : nl101lO;
	assign		wire_nliO0ll_dataout = ((~ nilOiil) === 1'b1) ? nl100OO : nl101Oi;
	assign		wire_nliO0lO_dataout = ((~ nilOiil) === 1'b1) ? nl10i1i : nl101Ol;
	and(wire_nliO0O_dataout, wire_nll0il_dataout, niO00li);
	assign		wire_nliO0Oi_dataout = ((~ nilOiil) === 1'b1) ? nl10i1l : nl101OO;
	assign		wire_nliO0Ol_dataout = ((~ nilOiil) === 1'b1) ? nl10i1O : nl1001i;
	assign		wire_nliO0OO_dataout = ((~ nilOiil) === 1'b1) ? nl10i0i : nl1001l;
	assign		wire_nliO10i_dataout = ((~ nilOiil) === 1'b1) ? nl101il : nl100li;
	assign		wire_nliO10l_dataout = ((~ nilOiil) === 1'b1) ? nl101iO : nl100ll;
	assign		wire_nliO10O_dataout = ((~ nilOiil) === 1'b1) ? nl101li : nl100lO;
	assign		wire_nliO11i_dataout = ((~ nilOiil) === 1'b1) ? nl1010l : nl100ii;
	assign		wire_nliO11l_dataout = ((~ nilOiil) === 1'b1) ? nl1010O : nl100il;
	assign		wire_nliO11O_dataout = ((~ nilOiil) === 1'b1) ? nl101ii : nl100iO;
	and(wire_nliO1i_dataout, wire_nll01O_dataout, niO00li);
	assign		wire_nliO1ii_dataout = ((~ nilOiil) === 1'b1) ? nl101ll : nl100Oi;
	assign		wire_nliO1il_dataout = ((~ nilOiil) === 1'b1) ? nl101lO : nl100Ol;
	assign		wire_nliO1iO_dataout = ((~ nilOiil) === 1'b1) ? nl101Oi : nl100OO;
	and(wire_nliO1l_dataout, wire_nll00i_dataout, niO00li);
	assign		wire_nliO1li_dataout = ((~ nilOiil) === 1'b1) ? nl101Ol : nl10i1i;
	assign		wire_nliO1ll_dataout = ((~ nilOiil) === 1'b1) ? nl101OO : nl10i1l;
	assign		wire_nliO1lO_dataout = ((~ nilOiil) === 1'b1) ? nl1001i : nl10i1O;
	and(wire_nliO1O_dataout, wire_nll00l_dataout, niO00li);
	assign		wire_nliO1Oi_dataout = ((~ nilOiil) === 1'b1) ? nl1001l : nl10i0i;
	assign		wire_nliO1Ol_dataout = ((~ nilOiil) === 1'b1) ? nl1001O : nl1011i;
	assign		wire_nliO1OO_dataout = ((~ nilOiil) === 1'b1) ? nl1000i : nl1011l;
	and(wire_nliOii_dataout, wire_nll0iO_dataout, niO00li);
	assign		wire_nliOiil_dataout = (nilOill === 1'b1) ? wire_nliOl0i_dataout : wire_nliOill_dataout;
	assign		wire_nliOiiO_dataout = (nilOill === 1'b1) ? wire_nliOl0l_dataout : wire_nliOilO_dataout;
	and(wire_nliOil_dataout, wire_nll0li_dataout, niO00li);
	assign		wire_nliOili_dataout = (nilOill === 1'b1) ? wire_nliOl0O_dataout : wire_nliOiOi_dataout;
	assign		wire_nliOill_dataout = (nilOiiO === 1'b1) ? wire_nliOiOl_dataout : nliOi1l;
	assign		wire_nliOilO_dataout = (nilOiiO === 1'b1) ? wire_nliOiOO_dataout : nliOi0l;
	and(wire_nliOiO_dataout, wire_nll0ll_dataout, niO00li);
	assign		wire_nliOiOi_dataout = (nilOiiO === 1'b1) ? wire_nliOl1i_dataout : nliOi0O;
	assign		wire_nliOiOl_dataout = ((~ nilOill) === 1'b1) ? wire_nliOl1l_o[1] : nliOi1l;
	assign		wire_nliOiOO_dataout = ((~ nilOill) === 1'b1) ? wire_nliOl1l_o[2] : nliOi0l;
	assign		wire_nliOl0i_dataout = ((~ nilOiiO) === 1'b1) ? wire_nliOlii_o[0] : nliOi1l;
	assign		wire_nliOl0l_dataout = ((~ nilOiiO) === 1'b1) ? wire_nliOlii_o[1] : nliOi0l;
	assign		wire_nliOl0O_dataout = ((~ nilOiiO) === 1'b1) ? wire_nliOlii_o[2] : nliOi0O;
	assign		wire_nliOl1i_dataout = ((~ nilOill) === 1'b1) ? wire_nliOl1l_o[3] : nliOi0O;
	...
	assign		wire_nliOlOO_dataout = (nilOill === 1'b1) ? wire_nliOOlO_dataout : wire_nliOO1O_dataout;
	assign		wire_nliOO0i_dataout = (nilOilO === 1'b1) ? wire_nliOOii_dataout : nliOlOi;
	assign		wire_nliOO0l_dataout = (nilOilO === 1'b1) ? wire_nliOOil_dataout : nliOlOl;
	assign		wire_nliOO0O_dataout = ((~ nilOill) === 1'b1) ? wire_nliOOiO_o[1] : nliOlll;
	assign		wire_nliOO1i_dataout = (nilOill === 1'b1) ? wire_nliOOOi_dataout : wire_nliOO0i_dataout;
	assign		wire_nliOO1l_dataout = (nilOill === 1'b1) ? wire_nliOOOl_dataout : wire_nliOO0l_dataout;
	assign		wire_nliOO1O_dataout = (nilOilO === 1'b1) ? wire_nliOO0O_dataout : nliOlll;
	and(wire_nliOOi_dataout, wire_nll0OO_dataout, niO00li);
	assign		wire_nliOOii_dataout = ((~ nilOill) === 1'b1) ? wire_nliOOiO_o[2] : nliOlOi;
	assign		wire_nliOOil_dataout = ((~ nilOill) === 1'b1) ? wire_nliOOiO_o[3] : nliOlOl;
	assign		wire_nliOOl_dataout = ((~ niO00OO) === 1'b1) ? niOil0l : niOii0i;
	assign		wire_nliOOlO_dataout = ((~ nilOilO) === 1'b1) ? wire_nliOOOO_o[0] : nliOlll;
	assign		wire_nliOOO_dataout = ((~ niO00OO) === 1'b1) ? niOil0O : niOii0l;
	assign		wire_nliOOOi_dataout = ((~ nilOilO) === 1'b1) ? wire_nliOOOO_o[1] : nliOlOi;
	assign		wire_nliOOOl_dataout = ((~ nilOilO) === 1'b1) ? wire_nliOOOO_o[2] : nliOlOl;
	...
	assign		wire_nll011l_dataout = ((~ niO00Ol) === 1'b1) ? nl00OOl : niO110i;
	...
	assign		wire_nlli0li_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[0] : nll0O0l;
	assign		wire_nlli0ll_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[1] : nlll1li;
	assign		wire_nlli0lO_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[2] : nlll0Oi;
	assign		wire_nlli0Oi_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[3] : nlll0Ol;
	assign		wire_nlli0Ol_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[4] : nll0O0i;
	assign		wire_nlli0OO_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[5] : nll0O1O;
	...
	assign		wire_nllii0i_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[9] : nll0lOl;
	assign		wire_nllii0l_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[10] : nll0lOi;
	assign		wire_nllii0O_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[11] : nll0llO;
	assign		wire_nllii1i_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[6] : nll0O1l;
	assign		wire_nllii1l_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[7] : nll0O1i;
	assign		wire_nllii1O_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[8] : nll0lOO;
	assign		wire_nlliiii_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[12] : nll0lll;
	assign		wire_nlliiil_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[13] : nll0lli;
	assign		wire_nlliiiO_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[14] : nll0liO;
	assign		wire_nlliili_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[15] : nll0lil;
	assign		wire_nlliill_dataout = (nilOiOl === 1'b1) ? wire_nlliilO_o[16] : nll0lii;
	...
	assign		wire_nlllOi_dataout = (nlOlOl === 1'b1) ? ((((niO0ill & nlllli) | (nlllli & niO110l)) | (niO0ill & niO110l)) ^ (niO0ili ^ nllOil)) : wire_nllO1l_dataout;
	assign		wire_nlllOl_dataout = (nlOlOl === 1'b1) ? (niO110l ^ (niO0ill ^ nlllli)) : wire_nllO1O_dataout;
	assign		wire_nlllOO_dataout = (nlOlOl === 1'b1) ? (niO110O ^ (niO0ilO ^ nlllll)) : wire_nllO0i_dataout;
	and(wire_nllO0i_dataout, wire_nllO0O_o[2], ~(niO11ii));
	and(wire_nllO0l_dataout, wire_nllO0O_o[3], ~(niO11ii));
	...
	and(wire_nllO1l_dataout, wire_nllO0O_o[0], ~(niO11ii));
	and(wire_nllO1O_dataout, wire_nllO0O_o[1], ~(niO11ii));
	...
	assign		wire_nllOO0i_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[0] : nllO0Ol;
	assign		wire_nllOO0l_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[1] : nlO1l0i;
	assign		wire_nllOO0O_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[2] : nlO1Oii;
	...
	assign		wire_nllOOii_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[3] : nlO1OiO;
	assign		wire_nllOOil_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[4] : nllO0Oi;
	assign		wire_nllOOiO_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[5] : nllO0lO;
	assign		wire_nllOOli_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[6] : nllO0ll;
	assign		wire_nllOOll_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[7] : nllO0li;
	assign		wire_nllOOlO_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[8] : nllO0iO;
	assign		wire_nllOOOi_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[9] : nllO0il;
	assign		wire_nllOOOl_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[10] : nllO0ii;
	assign		wire_nllOOOO_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[11] : nllO00O;
	...
	assign		wire_nlO0ii_dataout = (nlOlOl === 1'b1) ? ((((niO0ill & nlO00i) | (nlO00i & niO11ll)) | (niO0ill & niO11ll)) ^ (niO0ili ^ nlOi1i)) : wire_nlO0ll_dataout;
	assign		wire_nlO0il_dataout = (nlOlOl === 1'b1) ? (niO11ll ^ (niO0ill ^ nlO00i)) : wire_nlO0lO_dataout;
	assign		wire_nlO0iO_dataout = (nlOlOl === 1'b1) ? (niO11lO ^ (niO0ilO ^ nlO00l)) : wire_nlO0Oi_dataout;
	assign		wire_nlO0li_dataout = (nlOlOl === 1'b1) ? (niO0iOi ^ nlO00O) : wire_nlO0Ol_dataout;
	and(wire_nlO0ll_dataout, wire_nlO0OO_o[0], ~(niO11Oi));
	and(wire_nlO0lO_dataout, wire_nlO0OO_o[1], ~(niO11Oi));
	and(wire_nlO0Oi_dataout, wire_nlO0OO_o[2], ~(niO11Oi));
	and(wire_nlO0Ol_dataout, wire_nlO0OO_o[3], ~(niO11Oi));
	...
	assign		wire_nlO110i_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[15] : nllO01l;
	assign		wire_nlO110l_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[16] : nllO01i;
	assign		wire_nlO111i_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[12] : nllO00l;
	assign		wire_nlO111l_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[13] : nllO00i;
	assign		wire_nlO111O_dataout = (nilOiOO === 1'b1) ? wire_nlO110O_o[14] : nllO01O;
	...
	or(wire_nlOl1i_dataout, wire_nlOl1l_dataout, (niO100i & niO101O));
	and(wire_nlOl1l_dataout, nlOl0i, ~(niO100i));
	and(wire_nlOlii_dataout, wire_nlOliO_dataout, ~(((~ niO101O) & niO11Ol)));
	assign		wire_nlOliO_dataout = (niO100i === 1'b1) ? wire_nlOlli_dataout : nlOiOO;
	or(wire_nlOlli_dataout, nlOiOO, niO101O);
	...
	assign		wire_nlOO1l_dataout = (niO101O === 1'b1) ? (~ nlOlOl) : nlOlOl;
	and(wire_nlOO1ll_dataout, wire_nlOO00l_dataout, ~((~ reset_n)));
	and(wire_nlOO1lO_dataout, wire_nlOO00O_dataout, ~((~ reset_n)));
	assign		wire_nlOO1O_dataout = ((niO100i | (~ nlOl0i)) === 1'b1) ? (niO100i & nlOlll) : (wire_nlOOiO_dataout & nlOlll);
	...
	assign		wire_nlOOiO_dataout = (((niO100i & ((((~ nlOi1i) & (~ nlO00O)) & (~ nlO00l)) & (~ nlO00i))) | (~ nlOl0i)) === 1'b1) ? niO100i : (~ nlOl0l);
	...
	oper_add   n11OO
	( 
	.a({n11il, n11ii, n110O, n110l, nlili}),
	.b({{4{1'b0}}, 1'b1}),
	.cin(1'b0),
	.cout(),
	.o(wire_n11OO_o));
	...
	.o(wire_nli0i_o),
	.sel({(nliOO | nliOi), ((niO1iOl32 ^ niO1iOl31) & nlilO), nii0O}));
	defparam
		nli0i.width_data = 3,
		nli0i.width_sel = 3;
	oper_selector   nli0O
	...
	.o(wire_nli0O_o),
	.sel({((niO1iOO30 ^ niO1iOO29) & nliOO), nliOi, ((niO1l1i28 ^ niO1l1i27) & nlilO), ((niO1l1l26 ^ niO1l1l25) & nii0O)}));
	defparam
		nli0O.width_data = 4,
		nli0O.width_sel = 4;
	oper_selector   nliii
	( 
	.data({wire_nlOO1O_dataout, ((niO1l1O24 ^ niO1l1O23) & wire_n101l_dataout), ((niO1l0i22 ^ niO1l0i21) & wire_n101i_dataout), 1'b0}),
	.o(wire_nliii_o),
	...
	.o(wire_nliil_o),
	.sel({nliOO, nliOi, niO1l0l}));
	defparam
		nliil.width_data = 3,
		nliil.width_sel = 3;
	assign
		fftpts_out = {niO0iOi, niO0ilO, niO0ill, niO0ili, niO0iii},
		nilO00i = (nilO00l & (~ nilO0iO)),
		nilO00l = (sink_valid & niO1OOl),
		nilO00O = (nilO0ii & (~ nll1i)),
		nilO01i = (nilO01l | (((niOi10O & niOi10i) & niOi11O) & niO0OlO)),
		nilO01l = (((((~ wire_niOO0iO_o[5]) & (~ (wire_niOO0iO_o[1] ^ niO0OlO))) & (~ (wire_niOO0iO_o[2] ^ niOi11O))) & (~ (wire_niOO0iO_o[3] ^ niOi10i))) & (~ (wire_niOO0iO_o[4] ^ niOi10O))),
		nilO01O = (sink_sop | niOi00l),
		nilO0ii = ((~ nll0O) & niOO01O),
		nilO0il = ((sink_valid & ((~ niOO01O) & nilO0iO)) & (~ nll1i)),
		nilO0iO = ((~ niO00ii) & ((nll0O & nilO1OO) & (~ nilO1ll))),
		nilO0li = (((((~ wire_niOO0iO_o[5]) & (~ (wire_niOO0iO_o[1] ^ niO0O0O))) & (~ (wire_niOO0iO_o[2] ^ niO0Oil))) & (~ (wire_niOO0iO_o[3] ^ niO0OiO))) & (~ (wire_niOO0iO_o[4] ^ niO0Oll))),
		nilO0ll = (wire_nliill_dataout & wire_niOO0OO_dataout),
		nilO0lO = (((((~ (nl11iil ^ nl1111O)) & (~ (nl11l0O ^ nl1110i))) & (~ (nl11lii ^ nl1110l))) & (~ (nl11lil ^ nl1110O))) & (~ (nl11liO ^ nl111ii))),
		nilO0Oi = (wire_nl11i1l_o & nilO0Ol),
		nilO0Ol = (((((~ nl11iii) & (~ nl11i1O)) & (~ nl111il)) & (~ (niO000i ^ nl11i0i))) & (~ ((~ niO000i) ^ nl11i0l))),
		nilO0OO = (((((~ (nl11iil ^ nl111il)) & (~ (nl11l0O ^ nl11i1O))) & (~ (nl11lii ^ nl11i0i))) & (~ (nl11lil ^ nl11i0l))) & (~ (nl11liO ^ nl11iii))),
		nilO1ll = (((((~ (fftpts_in[0] ^ niO0iii)) & (~ (fftpts_in[1] ^ niO0ili))) & (~ (fftpts_in[2] ^ niO0ill))) & (~ (fftpts_in[3] ^ niO0ilO))) & (~ (fftpts_in[4] ^ niO0iOi))),
		nilO1lO = ((niO1OOl & nilO1OO) & (~ nilO0iO)),
		nilO1Oi = (fftpts_in[1] | fftpts_in[3]),
		nilO1Ol = (nilO1OO & nilO0iO),
		nilO1OO = (sink_valid & sink_sop),
		nilOi0i = (wire_nl00iiO_o & nilOi0l),
		nilOi0l = (((((~ nl00iOl) & (~ nl00ilO)) & (~ nl001OO)) & (~ (niO000i ^ nl00ili))) & (~ ((~ niO000i) ^ nl00ill))),
		nilOi0O = (((((~ (nl00iOO ^ nl001OO)) & (~ (nl00lOi ^ nl00ili))) & (~ (nl00lOl ^ nl00ill))) & (~ (nl00lOO ^ nl00ilO))) & (~ (nl00O1i ^ nl00iOl))),
		nilOi1i = (wire_nliill_dataout & wire_niOO0OO_dataout),
		nilOi1l = (wire_niOO0OO_dataout & nl11OOi),
		nilOi1O = (((((~ (nl00iOO ^ nl001li)) & (~ (nl00lOi ^ nl001ll))) & (~ (nl00lOl ^ nl001lO))) & (~ (nl00lOO ^ nl001Oi))) & (~ (nl00O1i ^ nl001Ol))),
		nilOiii = (wire_niOO0OO_dataout & nl11OOi),
		nilOiil = ((~ nl01l1l) & nl01l1i),
		nilOiiO = (nl0i10l & nl0i11O),
		nilOili = (wire_niOO0OO_dataout & (wire_nliill_dataout | nliOiii)),
		nilOill = (wire_nliill_dataout & wire_nliili_dataout),
		nilOilO = (nl11OOi & nl11Oii),
		nilOiOi = (wire_niOO0OO_dataout & nll111O),
		nilOiOl = ((nll0l0O | nll0i1i) & nll00OO),
		nilOiOO = ((nllO1OO | nlllOli) & nlllOiO),
		nilOl0O = (((((~ (n0101i ^ n1Olll)) & (~ (n010Ol ^ n1OllO))) & (~ (n010OO ^ n1OlOi))) & (~ (n01i1i ^ n1OlOl))) & (~ (n01i1l ^ n1OlOO))),
		nilOl1O = (wire_niOO0OO_dataout & nlOliOi),
		nilOlii = (wire_n011li_o & nilOlil),
		nilOlil = (((((~ n011OO) & (~ n011Oi)) & (~ n011lO)) & (~ (niO000i ^ n1OO1i))) & (~ ((~ niO000i) ^ n011ll))),
		nilOlll = (((((~ (n0101i ^ n1OO1i)) & (~ (n010Ol ^ n011ll))) & (~ (n010OO ^ n011lO))) & (~ (n01i1i ^ n011Oi))) & (~ (n01i1l ^ n011OO))),
		nilOllO = (wire_niOO0OO_dataout & nlOliOi),
		nilOlOi = (wire_niOO0OO_dataout & n01l0O),
		nilOO0i = (((((~ (ni010l ^ ni1l0l)) & (~ (ni001O ^ ni1OOO))) & (~ (ni000i ^ ni011i))) & (~ (ni000l ^ ni011l))) & (~ (ni000O ^ ni010i))),
		nilOO0l = (wire_niOO0OO_dataout & n01l0O),
		nilOO0O = (ni10Oi & (~ ni11ii)),
		nilOO1i = (((((~ (ni010l ^ ni1iOO)) & (~ (ni001O ^ ni1l1i))) & (~ (ni000i ^ ni1l1l))) & (~ (ni000l ^ ni1l1O))) & (~ (ni000O ^ ni1l0i))),
		nilOO1l = (wire_ni1OOl_o & nilOO1O),
		nilOO1O = (((((~ ni010i) & (~ ni011l)) & (~ ni011i)) & (~ ni1OOO)) & (~ ((~ niO000i) ^ ni1l0l))),
		nilOOii = (nll111O & nll111i),
		nilOOil = (wire_niOill_dataout & wire_niOili_dataout),
		nilOOiO = (nilOOlO | ((~ nl0iOi) & (~ nl0ilO))),
		nilOOli = (nl0iii & nl1ilO),
		nilOOll = (nilOOlO | (nl0iOi & (~ nl0ilO))),
		nilOOlO = ((~ nl0iOi) & nl0ilO),
		nilOOOO = 1'b0,
		niO100i = (wire_niOO0OO_dataout & wire_niOill_dataout),
		niO100l = (source_ready & niO1l0l),
		niO100O = ((wire_nlOO1O_dataout & nliOO) | ((nliOi & niO1iil) & (niO10ii50 ^ niO10ii49))),
		niO101O = (((((~ wire_nlOOii_o[5]) & (~ (wire_nlOOii_o[1] ^ nlOi1i))) & (~ (wire_nlOOii_o[2] ^ nlO00i))) & (~ (wire_nlOOii_o[3] ^ nlO00l))) & (~ (wire_nlOOii_o[4] ^ nlO00O))),
		niO10lO = ((nlilO & niO1ill) & (niO10Oi44 ^ niO10Oi43)),
		niO10OO = ((source_ready & nii0O) & (niO1i1i42 ^ niO1i1i41)),
		niO110i = ((((~ niO0Oll) & (~ niO0OiO)) & (~ niO0Oil)) & (~ niO0O0O)),
		niO110l = (((niO0ilO & nlllll) | (nlllll & niO110O)) | (niO0ilO & niO110O)),
		niO110O = (niO0iOi & nllllO),
		niO111i = ((((~ niO000i) & (wire_nl111i_dataout & wire_niOOOO_dataout)) | (niO000i & (wire_nl111i_dataout & (~ wire_niOOOO_dataout)))) | wire_nl0Oli_o),
		niO111l = ((~ niO00Ol) & nll111O),
		niO111O = (wire_niOO0OO_dataout & wire_niOiil_dataout),
		niO11ii = (((((~ wire_nllOiO_o[5]) & (~ (wire_nllOiO_o[1] ^ nllOil))) & (~ (wire_nllOiO_o[2] ^ nlllli))) & (~ (wire_nllOiO_o[3] ^ nlllll))) & (~ (wire_nllOiO_o[4] ^ nllllO))),
		niO11li = (wire_nlOOiO_dataout & nlOiOO),
		niO11ll = (((niO0ilO & nlO00l) | (nlO00l & niO11lO)) | (niO0ilO & niO11lO)),
		niO11lO = (niO0iOi & nlO00O),
		niO11Oi = (((((~ wire_nlOi1l_o[5]) & (~ (wire_nlOi1l_o[1] ^ nlOi1i))) & (~ (wire_nlOi1l_o[2] ^ nlO00i))) & (~ (wire_nlOi1l_o[3] ^ nlO00l))) & (~ (wire_nlOi1l_o[4] ^ nlO00O))),
		niO11Ol = (((((~ wire_nlOOii_o[5]) & (~ (wire_nlOOii_o[1] ^ nllOil))) & (~ (wire_nlOOii_o[2] ^ nlllli))) & (~ (wire_nlOOii_o[3] ^ nlllll))) & (~ (wire_nlOOii_o[4] ^ nllllO))),
		niO1i1O = ((((nliOi & niO1ill) & (niO1iiO36 ^ niO1iiO35)) | ((nlilO & niO1iil) & (niO1i0O38 ^ niO1i0O37))) | (~ (niO1i0i40 ^ niO1i0i39))),
		niO1iil = ((source_ready & wire_nlOO1O_dataout) & (niO10iO48 ^ niO10iO47)),
		niO1ill = ((~ source_ready) & wire_nlOO1O_dataout),
		niO1l0l = (nlilO | nii0O),
		niO1lOi = (source_ready & niO1OiO),
		niO1O1O = 1'b1,
		niO1OiO = (((nliOi | nlilO) | (~ (niO1ilO34 ^ niO1ilO33))) | nii0O),
		niO1Oli = (((((~ (nlili ^ wire_n100i_o[1])) & (~ (wire_n100i_o[2] ^ n110l))) & (~ (wire_n100i_o[3] ^ n110O))) & (~ (wire_n100i_o[4] ^ n11ii))) & (~ (wire_n100i_o[5] ^ n11il))),
...
endmodule //fft_ii_0_example_design_core
